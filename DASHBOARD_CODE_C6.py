...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        total_failure_count = spacex_df[spacex_df['class'] == 0].shape[0]
        # Use all rows for all sites
        fig = px.pie(values=[total_success_count, total_failure_count],
        names=['Success', 'Failure'], 
        title='Use all rows for all sites title')
    else:
        ...
        names=['Success', 'Failure'], 
        title='Filter data for for {}'.format(entered_site))
...
def render_scatter(entered_site, payload_value):
    if entered_site == 'ALL':
        ...
        fig = px.scatter(filtered_df,
                         ...
                         y='class',
                         color='Booster Version Category',
                         title=f'Payload Mass vs Class for Site {entered_site}')
